...
\newcommand{\vrulecode}{\noindent\colorbox{$titlepage-theme.vrule-color$}{\begin{minipage}[b][1\textheight][s]{\vrulewidth}

\vspace{$titlepage-theme.top-space$}

\hspace{$titlepage-theme.vrule-hspace$}{\logoblock}
...
\setlength{\parindent}{$titlepage-theme.vrule-hspace$}

\parbox{1in}{%

{\Large{\color{$titlepage-theme.vrule-text-color$}
\linespread{1}\selectfont
$titlepage-theme.vrule-text$
}}}

\vspace{0.25in}

\makebox[\textwidth][l]{\Large{\color{$titlepage-theme.vrule-text-color$}sreb.org}}

\setlength{\parindent}{15pt}
% 0.625 space from bottom of page
\vspace{0.625in}
